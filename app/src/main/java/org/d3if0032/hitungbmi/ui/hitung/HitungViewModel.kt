package org.d3if0032.hitungbmi.ui.hitung
...
import org.d3if0032.hitungbmi.data.HasilBmi
import org.d3if0032.hitungbmi.data.HitungBmi
import org.d3if0032.hitungbmi.data.KategoriBmi
import org.d3if0032.hitungbmi.db.BmiDao
import org.d3if0032.hitungbmi.db.BmiEntity
...
class HitungViewModel(private val db: BmiDao) : ViewModel() {
    ...
    fun hitungBmi(berat: String, tinggi: String, isMale: Boolean) {
        ...
        hasilBmi.value = HitungBmi.HitungBmi.hitung(dataBmi)
